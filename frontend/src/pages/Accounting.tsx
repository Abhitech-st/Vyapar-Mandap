          ...
          <div className="glass-card rounded-xl p-5 space-y-4 shadow-sm">
            ...
            <div className="space-y-3">
              <input
                ...
                className="w-full bg-white border border-slate-300 rounded-lg p-2.5 text-xs text-slate-900 font-medium focus:outline-none focus:border-blue-600 shadow-inner"
              />
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-2xl w-full max-w-md p-6 space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div>
                ...
                <input type="text" value={newAccCode} onChange={(e) => setNewAccCode(e.target.value)} placeholder="e.g. 5210" className="w-full mt-1 p-2 bg-slate-50 border border-slate-300 rounded font-mono font-bold" />
              </div>
              <div>
                <label className="font-bold text-slate-700">Account Name</label>
                <input type="text" value={newAccName} onChange={(e) => setNewAccName(e.target.value)} placeholder="e.g. Cloud Software Subscriptions" className="w-full mt-1 p-2 bg-slate-50 border border-slate-300 rounded font-bold" />
              </div>
              <div>
                <label className="font-bold text-slate-700">Account Type</label>
                <select value={newAccType} onChange={(e) => setNewAccType(e.target.value)} className="w-full mt-1 p-2 bg-slate-50 border border-slate-300 rounded font-bold">
            ...
            <div className="flex justify-end space-x-3 pt-2">
              <button onClick={() => setIsAddAccountModalOpen(false)} className="px-4 py-2 bg-slate-100 text-slate-700 rounded-lg text-xs font-semibold">Cancel</button>
              <button onClick={handleAddAccount} className="px-4 py-2 bg-blue-600 text-white rounded-lg text-xs font-bold">Create Account</button>
            </div>
          </div>
        </div>
      )}
