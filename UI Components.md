...
- Views & Screens: [[Pages]]
- Workflow Integration: [[User Flows]]
...
4. **`ActivityTimeline.tsx`**: GitHub/Linear-style event ticker rendering live AI agent execution step logs and confidence metrics from [[AI Agents]].
5. **`AgentMonitor.tsx`**: Interactive graph visualizer displaying deployed AI agents and status.
6. **`DocumentViewer.tsx`**: HTML5 Canvas rendering component for tax invoice previewing used in [[Pages]].
